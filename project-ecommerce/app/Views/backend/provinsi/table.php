...
<h1 class="h3 mb-2 text-gray-800">Data Provinsi</h1>
                    <p class="mb-4">Data Provinsi untuk mengelola data pengguna yang ada di sistem.</p>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="post" action="<?=base_url('provinsi')?>" id="formPengguna">
...
<script src="//cdn.datatables.net/1.12.1/js/jquery.dataTables.min.js"></script> 
  ...
  $(document).ready(function(){
    ...
    $("table#table-pengguna").on("click",".btn-edit",function(){
      ...
      $.get(`${baseurl}/provinsi/${id}`).done((e)=>{
    ...
    $("table#table-pengguna").on("click", "btn-hapus",function(){
      ...
      if(konfirmasi  === true){
        ...
        $.post(`${baseurl}/provinsi`,{id:_id, _method:"delete"}).done(function(e){
          $("table#table-pengguna").DataTable().ajax.reload();
        });
      }
    });
    ...
    serverSide: true,
    ajax:{
      url: "<?=base_url('provinsi/all')?>",method: 'GET'
      },
      columns:
      [
