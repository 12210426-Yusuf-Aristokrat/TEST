    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="post" action="<?=base_url('kategoriproduk')?>" id="formPengguna">
...
<script src="//cdn.datatables.net/1.12.1/js/jquery.dataTables.min.js"></script> 
  ...
  $(document).ready(function(){
    ...
    $("table#table-pengguna").on("click",".btn-edit",function(){
      ...
      $.get(`${baseurl}/kategoriproduk/${id}`).done((e)=>{
    ...
    $("table#table-pengguna").on("click", "btn-hapus",function(){
      ...
      if(konfirmasi  === true){
        ...
        $.post(`${baseurl}/kategoriproduk`,{id:_id, _method:"delete"}).done(function(e){
          $("table#table-pengguna").DataTable().ajax.reload();
        });
      }
    });
    ...
    serverSide: true,
    ajax:{
      url: "<?=base_url('kategoriproduk/all')?>",method: 'GET'
      },
      columns:
      [
