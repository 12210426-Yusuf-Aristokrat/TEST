...
<h1 class="h3 mb-2 text-gray-800">Data Produk</h1>
                    <p class="mb-4">Data Produk untuk mengelola data pengguna yang ada di sistem.</p>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="post" action="<?=base_url('produk')?>" id="formPengguna">
  ...
  $(document).ready(function(){
    ...
    $("table#table-pengguna").on("click",".btn-edit",function(){
      ...
      $.get(`${baseurl}/produk/${id}`).done((e)=>{
        ...
        $("input[name=detail_produk]").val(e.detail_produk);
        $("input[name=rating]").val(e.rating);
    ...
    serverSide: true,
    ajax:{
      url: "<?=base_url('produk/all')?>",method: 'GET'
      },
      columns:
      [
